...
function ProductList({ onHomeClick }) {
    ...
    // sync the cart items with the addedToCart state in case if user deletes the item from the cart
    // this will update the addedToCart state whenever the cart items change
    useEffect(() => {
